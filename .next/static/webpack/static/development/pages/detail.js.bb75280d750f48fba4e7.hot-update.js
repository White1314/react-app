...
/* harmony import */ var antd_lib_message__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! antd/lib/message */ "./node_modules/_antd@4.2.0@antd/lib/message/index.js");
...
var Detail = function Detail(_ref) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(repoIssues),
      issues = _useState[0],
      setIssues = _useState[1]; // 父组件执行筛选用户的操作


  var onChange = Object(react__WEBPACK_IMPORTED_MODULE_4__["useCallback"])(function _callee(value) {
    var data;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(Object(_server_utils_js__WEBPACK_IMPORTED_MODULE_6__["getApiData"])(null, "/repos/".concat(owner, "/").concat(name, "/issues?creator=").concat(value)));

          case 2:
            data = _context.sent;
            data.length ? setIssues(data) : antd_lib_message__WEBPACK_IMPORTED_MODULE_2___default.a.info('无结果');
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 7;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(Object(_server_utils_js__WEBPACK_IMPORTED_MODULE_6__["getApiData"])(ctx, "/repos/".concat(owner, "/").concat(name)));

        case 7:
          _context2.t2 = _context2.sent;
          _context2.next = 10;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(Object(_server_utils_js__WEBPACK_IMPORTED_MODULE_6__["getApiData"])(ctx, "/repos/".concat(owner, "/").concat(name, "/readme")));

        case 10:
          _context2.t3 = _context2.sent;
          _context2.next = 13;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(Object(_server_utils_js__WEBPACK_IMPORTED_MODULE_6__["getApiData"])(ctx, "/repos/".concat(owner, "/").concat(name, "/issues")));
        ...
        case 18:
          data = _context2.sent;
          store.dispatch(_actions__WEBPACK_IMPORTED_MODULE_7__["getDetailRepos"](data[0]));
          store.dispatch(_actions__WEBPACK_IMPORTED_MODULE_7__["getRepoReadme"](data[1]));
          store.dispatch(_actions__WEBPACK_IMPORTED_MODULE_7__["getRepoIssues"](data[2]));
...
//# sourceMappingURL=detail.js.bb75280d750f48fba4e7.hot-update.js.map